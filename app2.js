...
function clickMeThree() {
    swal("This artisit became the first female rapper with two Billboard Hot 100 No. 1s", {
        content: "input",
      })
      .then((value) => {
        if( value === "Who Cardi B"){
            score += 100
        }  
        document.getElementById("score1").innerHTML = score
      });
...
function seventhTD() {
    document.getElementById("tdSeven").style.background = "#EAA1CC"
    document.getElementById("tdSeven").innerHTML = "<span style= 'font-size: 40px'></span>"
}

function clickMeSeven() {
    swal(" This couple realsed a surprise album this year by the name of...", {
        content: "input",
      })
      .then((value) => {
...
function clickMeEight() {
    swal(" DAILY DOUBLE: This 28-Year-Old Latina Activist Just Beat New York's Most Powerful Congressional Rep", {
        content: "input",
      })
      .then((value) => {
